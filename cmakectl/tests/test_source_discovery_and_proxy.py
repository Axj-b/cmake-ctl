...
class SourceDiscoveryAndProxyTests(unittest.TestCase):
    def test_discover_source_dir_supports_S_and_preset_and_build_dir(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            from cmakectl.source_discovery import discover_source_dir
    ...
    def test_proxy_uses_absolute_managed_path_and_recursion_guard(self):
        with isolated_home():
            ...
            from cmakectl.proxy import RECURSION_ENV, ProxyError, resolve_cmake_executable, run_proxy
            ...
            with tempfile.TemporaryDirectory() as td:
                ...
                with mock.patch("cmakectl.proxy.subprocess.run") as run_mock:
